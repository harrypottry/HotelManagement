...
public class ShangmeiOTAService {
    ...
    public String getOTAToken() {
       ...
       /* if(token!=null && token.length()>0) {
        ...
        ResponseEntity<ShangmeiRetView> response = restTemplate.exchange("http://120.92.148.25:8099/rest/oauth/authorize", HttpMethod.GET, entity, ShangmeiRetView.class);
